...
N_approx  = 200          # number of approximations
...
write.csv(approx_N, "singular_lil_v1.csv", row.names = F)
test_read = read.csv("singular_lil_v1.csv")
...
approx_N = read.csv("singular_lil_v1.csv")
